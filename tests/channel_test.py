...
def test_channel_invite():
    ...
    with pytest.raises(InputError) as e:
        channel_invite_v1(userID1[auth_user_id], "ThischannelIDdoesNotExist", userID2[u_id])
    ...
    with pytest.raises(AccessError) as e:
        channel_invite_v1(userID3[auth_user_id], privateChannel[channel_id], userID2[u_id])
...
def test_channel_details():
    ...
    userID1 = src.auth.auth_register_v1("testing1@gmail.com", "Monkey", "Vincent", "Le")
    userID2 = src.auth.auth_register_v1("testing2@gmail.com", "jonkey", "Imposter", "Kuan")
